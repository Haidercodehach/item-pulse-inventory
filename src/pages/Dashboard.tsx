    ...
    <div className="min-h-screen bg-gradient-vibrant relative overflow-hidden">
      ...
      <div className="relative z-10 p-6 space-y-6 animate-fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="hover-lift animate-slide-up glass border-white/20 backdrop-blur-md" style={{ animationDelay: '100ms' }}>
          ...
          <Card className="hover-lift animate-slide-up glass border-white/20 backdrop-blur-md" style={{ animationDelay: '200ms' }}>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <Card className="hover-lift animate-slide-up glass border-white/20 backdrop-blur-md" style={{ animationDelay: '300ms' }}>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-white/90">Low Stock Items</CardTitle>
              <div className="p-2 bg-gradient-to-r from-orange-500 to-red-500 rounded-lg">
                <AlertTriangle className="h-4 w-4 text-white" />
              </div>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-orange-200">{metrics.lowStockItems}</div>
              <p className="text-xs text-white/70">Items below minimum level</p>
            </CardContent>
          </Card>

          <Card className="hover-lift animate-slide-up glass border-white/20 backdrop-blur-md" style={{ animationDelay: '400ms' }}>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-white/90">Recent Transactions</CardTitle>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="hover-lift animate-slide-up glass border-white/20 backdrop-blur-md" style={{ animationDelay: '500ms' }}>
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-white">
                <div className="w-2 h-2 bg-gradient-vibrant rounded-full animate-pulse-slow"></div>
                Inventory by Category
              </CardTitle>
              <CardDescription className="text-white/70">Distribution of items across categories</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="hover-lift animate-slide-up glass border-white/20 backdrop-blur-md" style={{ animationDelay: '600ms' }}>
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-white">
                <div className="w-2 h-2 bg-gradient-cool rounded-full animate-pulse-slow"></div>
                Recent Transaction Trends
              </CardTitle>
              <CardDescription className="text-white/70">Last 7 transactions</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
        ...
        {metrics.lowStockItems > 0 && (
          <Card className="border-orange-200/30 bg-gradient-to-r from-orange-500/20 to-red-500/20 hover-lift animate-slide-up glass backdrop-blur-md" style={{ animationDelay: '700ms' }}>
            <CardHeader>
            ...
            <CardContent>
              <div className="space-y-2">
                {items
                  ...
                  .slice(0, 5)
                  .map((item, index) => (
                    <div key={item.id} className="flex justify-between text-sm p-3 bg-white/10 rounded-lg animate-slide-in-right backdrop-blur-sm" style={{ animationDelay: `${index * 100}ms` }}>
