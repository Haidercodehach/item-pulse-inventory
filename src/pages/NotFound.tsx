    ...
    <div className="min-h-screen bg-gradient-vibrant relative overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center space-y-8 animate-fade-in">
        <div className="space-y-4">
          ...
          <h1 className="text-8xl font-bold text-white animate-scale-in">
            404
          </h1>
          ...
          <div className="space-y-2">
            ...
            <p
              className="text-lg text-white/80 animate-slide-up"
        ...
        <div
          className="glass rounded-3xl p-8 border-white/20 hover-lift animate-slide-up"
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              ...
              variant="outline"
              className="border-white/30 text-primary hover:bg-white hover:text-primary hover-lift"
            >
