      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-16 animate-slide-up">
          <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-6 py-2 mb-8 glass">
            ...
            <span className="text-white font-medium">Next Generation Inventory</span>
          </div>
            ...
            return (
              ...
              >
                <CardHeader>
                  ...
                  <CardTitle className="text-lg text-white mt-4">{feature.title}</CardTitle>
                </CardHeader>
                <CardContent>
        ...
        <div className="mt-20 text-center animate-slide-up">
          <div className="glass rounded-3xl p-12 border-white/20">
            ...
            <p className="text-white/80 mb-8 text-lg">Join thousands of businesses managing their inventory smarter</p>
            <Button 
              size="lg" 
              variant="outline"
              onClick={() => navigate('/auth')}
              className="border-white/30 text-white hover:bg-white hover:text-primary hover-lift text-lg px-8 py-4"
            >
